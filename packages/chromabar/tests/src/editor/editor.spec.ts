    ...
    var bodyActual = (new JSDOM("<!DOCTYPE html><svg></svg>")).window.document.body,
        bodyExpected = (new JSDOM(
          ...
          '<g class="colorbar" transform="translate(1, 1)">' +
            ...
            '<rect stroke-width="0" class="gradient" fill="rgb(0, 0, 0)" width="2" height="30" x="0" y="0"></rect>' +
            '<rect stroke-width="0" class="gradient" fill="rgb(26, 26, 26)" width="2" height="30" x="1" y="0"></rect>' +
            '<rect stroke-width="0" class="gradient" fill="rgb(51, 51, 51)" width="2" height="30" x="2" y="0"></rect>' +
            '<rect stroke-width="0" class="gradient" fill="rgb(77, 77, 77)" width="2" height="30" x="3" y="0"></rect>' +
            '<rect stroke-width="0" class="gradient" fill="rgb(102, 102, 102)" width="2" height="30" x="4" y="0"></rect>' +
            '<rect stroke-width="0" class="gradient" fill="rgb(128, 128, 128)" width="2" height="30" x="5" y="0"></rect>' +
            '<rect stroke-width="0" class="gradient" fill="rgb(153, 153, 153)" width="2" height="30" x="6" y="0"></rect>' +
            '<rect stroke-width="0" class="gradient" fill="rgb(179, 179, 179)" width="2" height="30" x="7" y="0"></rect>' +
            '<rect stroke-width="0" class="gradient" fill="rgb(204, 204, 204)" width="2" height="30" x="8" y="0"></rect>' +
            '<rect stroke-width="0" class="gradient" fill="rgb(230, 230, 230)" width="2" height="30" x="9" y="0"></rect>' +
