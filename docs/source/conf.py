...
# -*- coding: utf-8 -*-
#
# ipycolorbar documentation build configuration file
#
...
_version_py = os.path.join(repo, 'ipycolorbar', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'ipycolorbardoc'
...
latex_documents = [
    (master_doc, 'ipycolorbar.tex', 'ipycolorbar Documentation',
